$(document).ready(function (e) {
    ...
    //     translateBy += -260;
    //     console.log("translate(" + translateBy + "px)");
    //     document.getElementById('slide_wrapper').style.transform  = "translate(" + translateBy + "px)";
    // });
    ...
    $(document).on('click', '#sync1 .owl-nav .right', function(e) {
        $('#sync2 .owl-nav .right').trigger('click');
    });

    $(document).on('click', '#sync1 .owl-nav .left', function(e) {
        $('#sync2 .owl-nav .left').trigger('click');
    })
