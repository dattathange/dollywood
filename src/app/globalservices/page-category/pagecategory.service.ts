...
export class PageCategoryService {
    ...
    {
        this.navigationUrl = environment.baseURI + environment.apiURL + environment.pageCategoryAPI;
    }

    getPageCategories(_path: string, _deviceType: string, _type: string, _limit: number, _skip: number)
            : Observable<PageCategory> {
        ...
        apiRequest.limit = _limit;
        apiRequest.skip = _skip;
